...
export class AuthController {
  constructor(
    ...
    private readonly guardUtil: GuardUtil
  ) {}

  @Post('check-exist')
  @ApiPassedRes(AuthCheckExistRes, HttpStatus.OK)
  async checkExist(
    @Body() data: AuthCheckExistDto
  ): Promise<AuthCheckExistRes> {

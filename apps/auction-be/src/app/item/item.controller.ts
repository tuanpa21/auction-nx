import { IRequest, ApiPaginateRes, ApiPassedRes } from '@jitera/common'
import { IsAuthController } from '@jitera/guard'
import { Body, Delete, Get, HttpStatus, Logger, Param, Post, Put, Query, Req } from '@nestjs/common'
...
export class ItemController {
  ...
  @Put(':id')
  @ApiPassedRes(ItemModelRes, HttpStatus.OK)
  update(@Req() req: IRequest, @Param('id') id: string, @Body() data: ItemUpdateDto) {
